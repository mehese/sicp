...
(define c-zero1 (make-complex-from-real-imag 0 0))
(define c-zero2 (make-complex-from-mag-ang 0 0))
(define c-i (make-complex-from-real-imag 0 1))
(define c-j (make-complex-from-mag-ang 1 0))
(define c-rand (make-complex-from-real-imag 3 4))
...
(define r-zero1 (make-rational 0 1))
(define r-zero2 (make-rational 0 8))
(define r-a (make-rational 1 100))
(define r-b (make-rational 100 1))
...
(define n-zero (make-scheme-number 0))
(define n-1 (make-scheme-number 1))
(define n-2 (make-scheme-number 2))
