...
(define (install-number-operation-aliases)
  ...
  (put 'gcd '(scheme-number) greatest-common-div)
...
(define (install-rational-package)
  ...
  ;; This one goes back to the original
  (define (make-rat n d)
    (let ((g (gcd n d)))
      (cons (/ n g) (/ d g))))
  (define (add-rat x y)
...
(define (find-common-gcd numbers)
  (display "Finding common GCD for ")(display numbers)
  (newline)
  (if (= 2 (length numbers))
      (gcd (car numbers) (cadr numbers))
      (find-common-gcd (cons (gcd (car numbers)
                                  (cadr numbers))
                             (cddr numbers)))))
...
(define (install-polynomial-package)
  ...
  (define (pseudoremainder-terms a b)
    ;; Div terms returns a list of two elements, second element is the remainder
    (display "div-terms result is ") (display (car (div-terms a b)))
    (display " remainder: ") (display (cadr (div-terms a b))) (newline)
...
(greatest-common-divisor Q1 Q2); = P1 ✔