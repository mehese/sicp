...
(define (install-polynomial-package)
  ...
  (define (gcd-terms a b)
    ;; Probably is-zero would be a saner option, but would need to rewrite that to call a term list,
    ;;  as it currently works at poly level
    (if (empty-termlist? b) 
        a
...
(mul (greatest-common-divisor p2 p1) (car (div p2 (greatest-common-divisor p1 p2)))); ✔