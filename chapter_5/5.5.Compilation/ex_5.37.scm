...
'(COMPILER LOADED)
;; Trial and error, first I missed the first x until I arrived at the
;;  after-call8 label that didn't match
...
;; Clearly a lot of save/restores for no reason appear when preserve
;;  just saves all registers.
