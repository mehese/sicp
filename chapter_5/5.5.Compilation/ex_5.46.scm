...
; compiled
;
; total_pushes(n) = 10*Fib(n-1) + S(n-1)
;    max_depth(n) = 3*n - 1
;
; interpreted
;
; total_pushes(n) = 56*Fib(n-1) + S(n-1)
;    max_depth(n) = 5*n + 3  
;
; special (from Exercise 5.29)
;
; total_pushes(n) = 56*Fib(n + 1) - 40   
;    max_depth(n) =  5*n + 3                   
;                                              
;            total_pushes_compiled       lim   10*Fib(n-1) + S(n-1) 
;  ⇒  lim  -------------------------- = n → ∞ ---------------------- = 0.178... (approx 10/56)
;    n → ∞  total_pushes_interpreted           56*Fib(n-1) + S(n-1) 
;  
;             max_depth_compiled      3
;  ⇒  lim  ------------------------ = -
;    n → ∞   max_depth_interpreted    5
;                                            
;           total_pushes_special      lim    10*Fib(n+1) - 40
;  ⇒  lim  ----------------------- = n → ∞ ---------------------- = 5.6
;    n → ∞  total_pushes_compiled           56*Fib(n-1) + S(n-1)  
;  
;             max_depth_compiled      3
;  ⇒  lim  ------------------------ = -
;    n → ∞   max_depth_interpreted    5
