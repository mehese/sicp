...
; |----------|--------------------------------|--------------------------------|
; | n |  res |  total pushes |  maximum depth |  total pushes |  maximum depth |
; |:-:|:----:|:-------------:|:--------------:|:-------------:|:--------------:|
; | 1 |    1 |        7      |         3      |       16      |         8      |
; | 2 |    2 |       13      |         5      |       48      |        13      |
; | 3 |    6 |       19      |         8      |       80      |        18      |
...
; compiled
;
; total_pushes(n) = 6*n + 1
;    max_depth(n) = 3*n - 1
;
; interpreted
;
; total_pushes(n) = 32*n - 16
;    max_depth(n) =  5*n +  3
;
; special (from Exercise 5.14)
;
; total_pushes(n) = 2*n - 2
;    max_depth(n) = 2*n - 2
;
;            total_pushes_compiled       6    3 
;  ⇒  lim  -------------------------- = -- = -- 
;    n → ∞  total_pushes_interpreted    32   16 
;  
;             max_depth_compiled      3
;  ⇒  lim  ------------------------ = -
;    n → ∞   max_depth_interpreted    5 
;
;           total_pushes_special     2   1
;  ⇒  lim  ----------------------- = - = - 
;    n → ∞  total_pushes_compiled    6   3
;  
;             max_depth_compiled      2
;  ⇒  lim  ------------------------ = -
;    n → ∞   max_depth_interpreted    3    
;
;
; Part 2.
;
; 
; We are not open coding primitives in this version, that would win us some stack 
;  saves/restores as seen in the previous exercises.
