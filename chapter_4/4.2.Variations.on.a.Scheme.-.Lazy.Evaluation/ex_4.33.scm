...
;; Error produced by typing in (car '(a b c))

; Unknown procedure 
;                    type: APPLY {a b c}

;; See modification made to text-of-quotation (line 296) -- it now takes the environment
;;  as well and if the quotation is a pair, it makes sure to "redefine" this pair in
;;  terms of the cons defined in the scheme that's being evaluated.

;; Now the commands should work as expected
