...
;; The for-each example Ben shows works. But this is only because display is a primitive
;;  procedure in our interpreter.
...
;; Indeed it doesn't. The actual value of the sequence will be returned every time
;;  and in this case that is a display action
...
;; No clear cut answer. I like the text approach better as with Cy's we only get a
;;  half-lazy interpreter. As for the side-effects, one just needs to bite the bullet
;;  and accept that lazy evaluation + set! are not good buddies.
...
(define primitive-procedures
  (list (list 'car car)
        ...
        (list 'display display) ;; Added 'cause needed here
