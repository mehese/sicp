...
;
;;;; L-Eval value:
;<response>: 1 -- the definition of id needed to be ran when w was defined,
;                 and the argument needed calling
;
;;;; L-Eval input:
;w
;
;;;; L-Eval value:
;<response>: 10 -- w return 10 because that's what it does, but also triggers the outer
;                  id evaluation -> count is incremented
;
;;;; L-Eval input:
;count 
;
;;;; L-Eval value:
;⟨response⟩: 2  -- we have now ran id twice, so 2 counts
