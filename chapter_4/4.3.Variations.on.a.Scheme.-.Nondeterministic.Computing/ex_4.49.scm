...
;; found-word will not be returned from the *unparsed* words, but from
;;  the word list
...
'(begin
   ...
   ;; Like amb, but takes a list as an argument
   (define (list-amb l)
     (require (not (null? l)))
   ...
   (define (parse-word word-list)
     ...
     ;; Do not return words from the input, but from the word list
     (let ((found-word (list-amb (cdr word-list)))) ;; the car is the type, not
                                                    ;;  a valid word
