...
;; The cat is at the same level as lectures, so here it's implied the professor lectures
;;  with a cat, cat is a property of the lecture
;
;;;; Amb-Eval input:
;try-again
;
...
;                                         (simple-noun-phrase (article the) (noun cat)))))))
;
;; Here the cat is a property of the class, which is a property of the lecture
;
;;;; Amb-Eval input:
;try-again
;
...
;
;; Cat is again a propertu of the  lecture, but the class is a property of the student
...
;
;
; Class is a property of the student, cat is a property of the student
;
;
;;;; Amb-Eval input:
;try-again
...
;                                                                                                   (noun cat)))))))))
;
; cat is a property of the class which is a property of the student
;;;; Amb-Eval input:
;try-again
;
