...
(define custom-rules
  '(          
    ...
    (rule (can-replace ?replacer ?replacee)
          (and
           (job ?replacer ?job-replacer)
           (job ?replacee ?job-replacee)

           (or
            (same ?job-replacer ?job-replacee) ;; does the same job
            (can-do-job ?job-replacer  ?job-replacee)) ;; can do job
...
'(and
  (salary ?replacer ?salary-replacer)
  (salary ?replacee ?salary-replacee)
  (can-replace ?replacer ?replacee)
  (lisp-value < ?salary-replacer ?salary-replacee))
