...
;; Ben's sum function will sum up all the results returned, not all the *distinct*
;;  results obtained. He could salvage the situation by making sure he is only counting
;;  unique results obtained. Checking uniqueness generally implies creating a set of
;;  the results seen so far and making sure we're not adding any result twice. But
;;  for this changes would need to be made at the evaluator level -- which is decidedly
;;  NOT fun.
