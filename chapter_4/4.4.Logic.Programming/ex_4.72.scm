...
;; When cycling through solutions we want to make sure all variables are
;;  iterated through at least once. In case we have an infinite stream for
;;  one variable, we will never see a result from the second in our stream
;;  without interleaving -- (stream-append ones twos) will be functionally
;;  equivalent to ones will (interleave ones twos) will yield (1 2 1 2 ...)
