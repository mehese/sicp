...
;; The delay can actually stop some infinite loops from happening. For
;;  example in our Disney marriage loop
...
'(not (or (married Minnie Mickey) (married Minnie ?who)))

;; now enters an infinite loop while before it used to return a friendly
;;  empty result. And that is because now the troublesome
;;  (married Minnie ?who) query gets processed rather than delayed.
