...
'(and (address ?person ?where) (supervisor ?person (Bitdiddle Ben)))
...
'(and (salary ?person ?amount) 
      (salary (Bitdiddle Ben) ?benspay)
      (lisp-value < ?amount ?benspay))
...
'(and (supervisor ?person ?good-supervisor)
      (job ?good-supervisor ?super-job)
      (not (job ?good-supervisor (computer . ?etc))))

;;;; Query results:
;(and (supervisor (Aull DeWitt) (Warbucks Oliver)) (job (Warbucks Oliver) (administration big wheel)) (not (job (Warbucks Oliver) (computer . ?etc))))
;(and (supervisor (Cratchet Robert) (Scrooge Eben)) (job (Scrooge Eben) (accounting chief accountant)) (not (job (Scrooge Eben) (computer . ?etc))))
;(and (supervisor (Scrooge Eben) (Warbucks Oliver)) (job (Warbucks Oliver) (administration big wheel)) (not (job (Warbucks Oliver) (computer . ?etc))))
;(and (supervisor (Bitdiddle Ben) (Warbucks Oliver)) (job (Warbucks Oliver) (administration big wheel)) (not (job (Warbucks Oliver) (computer . ?etc))))
