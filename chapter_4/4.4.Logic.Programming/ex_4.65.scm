...
;; Indeed when running (Warbucks Oliver gets counted 4 times)
...
;; Let's look again at the definition of a wheel

;(rule (wheel ?person)
;      (and (supervisor ?middle-manager ?person)
;           (supervisor ?x ?middle-manager)))

;; Who is supervised by warbucks oliver?
...
;; Who is supervised by these people?
...
;; And there's our answer, Warbucks oliver gets counted for each person supervised
;;  by the people he's supervising, so that's 3 people under Ben + 1 person under
;;  Scrooge.
