...
;; I like to scan for definitions here, as the procedure body is a selector, and
;;  I would expect selectors not to modify the data I'm asking for underneath the
;;  hood. If I have a constructor however, I am ok with the constructor modifying
;;  the data as needed in order to create its returning data structure. 
